...
```
Con il seguente script posso creare una lista nera Ip:
## Script di aggiornamento IP
...
```
Lo script mette una lista PI (tor-ips.conf) nella directory "/etc/nginx/conf.d/". Controlla la configurazione del server e aggiorna le impostazioni di Nginx. Gli utenti bloccati lo vedranno:
