+++
date = "2022-04-18"
title = "Store ting med containere: Grafana på Synology - Diskstation"
difficulty = "level-3"
tags = ["Monitoring", "Grafana", "Docker", "docker-compose", "Synology", "influxdb", "telegraf"]
githublink = "https://github.com/terrorist-squad/knedelverse/blob/master/content/post/2022/april/20220418-docker-grafana/index.da.md"
+++
Grafana er en open source-applikation på tværs af platforme til grafisk visning af data fra forskellige datakilder som InfluxDB, MySQL, PostgreSQL eller Prometheus. I dag viser jeg, hvordan man installerer en Grafana-tjeneste på Synology DiskStation.
...
## Trin 2: Opret Grafana-mappe
Jeg opretter en ny mappe med navnet "grafana" i Docker-mappen.
{{< gallery match="images/3/*.png" >}}
Derefter opretter jeg en "grafana.yml"-fil i Grafana-mappen med dette indhold:
```
version: "2"
services:
  grafana:
...
```
Jeg opretter yderligere to undermapper til dataene:
{{< terminal >}}
mkdir grafana
mkdir influxdb
...
{{</ terminal >}}
Da jeg ønsker at bruge SSL til Grafana og den tilhørende grænseflade, skal der stadig oprettes et certifikat:
{{< terminal >}}
mkdir ssl
...
Endelig opretter jeg en "telegraf.conf"-fil med dette indhold:
```
[global_tags]
...
```
Start nu Grafana-serveren med dette Compose-opkald:
{{< terminal >}}
...
Nu kan jeg kalde serveren, konfigurere databasen, oprette dashboardet og forbinde flere måledata.
