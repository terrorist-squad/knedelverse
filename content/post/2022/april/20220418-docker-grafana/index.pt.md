+++
date = "2022-04-18"
title = "Grandes coisas com recipientes: Grafana on Synology - Diskstation"
difficulty = "level-3"
tags = ["Monitoring", "Grafana", "Docker", "docker-compose", "Synology", "influxdb", "telegraf"]
githublink = "https://github.com/terrorist-squad/knedelverse/blob/master/content/post/2022/april/20220418-docker-grafana/index.pt.md"
+++
...
Então eu crio um arquivo "grafana.yml" no diretório Grafana com este conteúdo:
```
version: "2"
services:
  grafana:
...
{{</ terminal >}}
Como eu quero usar SSL para Grafana e a interface associada, um certificado ainda precisa ser criado:
{{< terminal >}}
mkdir ssl
