+++
date = "2022-04-18"
title = "Wspaniałe rzeczy z kontenerami: Grafana na Synology - Diskstation"
difficulty = "level-3"
tags = ["Monitoring", "Grafana", "Docker", "docker-compose", "Synology", "influxdb", "telegraf"]
githublink = "https://github.com/terrorist-squad/knedelverse/blob/master/content/post/2022/april/20220418-docker-grafana/index.pl.md"
+++
Grafana to wieloplatformowa aplikacja open source do graficznego wyświetlania danych z różnych źródeł danych, takich jak InfluxDB, MySQL, PostgreSQL czy Prometheus. Dziś pokażę, jak zainstalować usługę Grafana na stacji Synology DiskStation.
...
## Krok 2: Utwórz folder Grafana
W katalogu Docker tworzę nowy katalog o nazwie "grafana".
{{< gallery match="images/3/*.png" >}}
Następnie w katalogu Grafana tworzę plik "grafana.yml" o następującej zawartości:
```
version: "2"
services:
  grafana:
...
```
Tworzę dwa kolejne podfoldery dla danych:
{{< terminal >}}
mkdir grafana
mkdir influxdb
...
{{</ terminal >}}
Ponieważ chcę używać SSL dla Grafany i powiązanego z nią interfejsu, trzeba jeszcze utworzyć certyfikat:
{{< terminal >}}
mkdir ssl
...
Na koniec tworzę plik "telegraf.conf" o następującej zawartości:
```
[global_tags]
...
```
Teraz uruchom serwer Grafana za pomocą tego wywołania Compose:
{{< terminal >}}
...
## Krok 3: Konfiguracja
Teraz mogę wywołać serwer, skonfigurować bazę danych, utworzyć pulpit nawigacyjny i podłączyć więcej danych pomiarowych.
