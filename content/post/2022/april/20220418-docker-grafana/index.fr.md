+++
date = "2022-04-18"
title = "De grandes choses avec les conteneurs : Grafana sur Synology - Diskstation"
difficulty = "level-3"
tags = ["Monitoring", "Grafana", "Docker", "docker-compose", "Synology", "influxdb", "telegraf"]
githublink = "https://github.com/terrorist-squad/knedelverse/blob/master/content/post/2022/april/20220418-docker-grafana/index.fr.md"
+++
...
En dernier lieu, je crée un fichier "telegraf.conf" avec ce contenu :
```
[global_tags]
