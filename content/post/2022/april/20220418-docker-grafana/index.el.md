+++
date = "2022-04-18"
title = "Μεγάλα πράγματα με κοντέινερ: Grafana στη Synology - Diskstation"
difficulty = "level-3"
tags = ["Monitoring", "Grafana", "Docker", "docker-compose", "Synology", "influxdb", "telegraf"]
githublink = "https://github.com/terrorist-squad/knedelverse/blob/master/content/post/2022/april/20220418-docker-grafana/index.el.md"
+++
Η Grafana είναι μια εφαρμογή ανοικτού κώδικα πολλαπλών πλατφορμών για τη γραφική απεικόνιση δεδομένων από διάφορες πηγές δεδομένων, όπως η InfluxDB, η MySQL, η PostgreSQL ή ο Prometheus. Σήμερα θα σας δείξω πώς να εγκαταστήσετε μια υπηρεσία Grafana στον Synology DiskStation.
...
## Βήμα 2: Δημιουργία φακέλου Grafana
Δημιουργώ έναν νέο κατάλογο με όνομα "grafana" στον κατάλογο Docker.
{{< gallery match="images/3/*.png" >}}
Στη συνέχεια, δημιουργώ ένα αρχείο "grafana.yml" στον κατάλογο Grafana με αυτό το περιεχόμενο:
```
version: "2"
services:
  grafana:
...
```
Δημιουργώ δύο ακόμη υποφακέλους για τα δεδομένα:
{{< terminal >}}
mkdir grafana
mkdir influxdb
...
{{</ terminal >}}
Δεδομένου ότι θέλω να χρησιμοποιήσω SSL για την Grafana και τη σχετική διεπαφή, πρέπει να δημιουργηθεί ένα πιστοποιητικό:
{{< terminal >}}
mkdir ssl
...
Τέλος, δημιουργώ ένα αρχείο "telegraf.conf" με αυτό το περιεχόμενο:
```
[global_tags]
...
```
Τώρα ξεκινήστε τον διακομιστή Grafana με αυτή την κλήση Compose:
{{< terminal >}}
...
## Βήμα 3: Διαμόρφωση
Τώρα μπορώ να καλέσω τον διακομιστή, να διαμορφώσω τη βάση δεδομένων, να δημιουργήσω ταμπλό και να συνδέσω περισσότερα δεδομένα μετρήσεων.
