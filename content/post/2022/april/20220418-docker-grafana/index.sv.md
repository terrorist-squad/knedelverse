+++
date = "2022-04-18"
title = "Stora saker med behållare: Grafana på Synology - Diskstation"
difficulty = "level-3"
tags = ["Monitoring", "Grafana", "Docker", "docker-compose", "Synology", "influxdb", "telegraf"]
githublink = "https://github.com/terrorist-squad/knedelverse/blob/master/content/post/2022/april/20220418-docker-grafana/index.sv.md"
+++
Grafana är ett plattformsoberoende program med öppen källkod för grafisk visning av data från olika datakällor som InfluxDB, MySQL, PostgreSQL eller Prometheus. Idag visar jag hur man installerar en Grafana-tjänst på Synology DiskStation.
...
## Steg 2: Skapa en Grafana-mapp
Jag skapar en ny katalog som heter "grafana" i Dockerkatalogen.
{{< gallery match="images/3/*.png" >}}
Sedan skapar jag en "grafana.yml"-fil i Grafana-katalogen med följande innehåll:
```
version: "2"
services:
  grafana:
...
```
Jag skapar ytterligare två undermappar för data:
{{< terminal >}}
mkdir grafana
mkdir influxdb
...
{{</ terminal >}}
Eftersom jag vill använda SSL för Grafana och det tillhörande gränssnittet måste ett certifikat skapas:
{{< terminal >}}
mkdir ssl
...
Slutligen skapar jag en fil "telegraf.conf" med detta innehåll:
```
[global_tags]
...
```
Starta nu Grafana-servern med detta Compose-anrop:
{{< terminal >}}
...
Nu kan jag ringa servern, konfigurera databasen, skapa en instrumentpanel och ansluta fler mätdata.
