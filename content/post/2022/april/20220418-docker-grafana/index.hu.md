+++
date = "2022-04-18"
title = "Nagyszerű dolgok konténerekkel: Grafana a Synology-n - Diskstation"
difficulty = "level-3"
tags = ["Monitoring", "Grafana", "Docker", "docker-compose", "Synology", "influxdb", "telegraf"]
githublink = "https://github.com/terrorist-squad/knedelverse/blob/master/content/post/2022/april/20220418-docker-grafana/index.hu.md"
+++
A Grafana egy platformokon átívelő nyílt forráskódú alkalmazás különböző adatforrásokból, például az InfluxDB, a MySQL, a PostgreSQL vagy a Prometheus adataiból származó adatok grafikus megjelenítésére. Ma megmutatom, hogyan lehet Grafana szolgáltatást telepíteni a Synology DiskStationre.
...
## 2. lépés: Grafana mappa létrehozása
Létrehozok egy új könyvtárat "grafana" néven a Docker könyvtárban.
{{< gallery match="images/3/*.png" >}}
Ezután létrehozok egy "grafana.yml" fájlt a Grafana könyvtárban ezzel a tartalommal:
```
version: "2"
services:
  grafana:
...
```
Létrehozok még két almappát az adatok számára:
{{< terminal >}}
mkdir grafana
mkdir influxdb
...
{{</ terminal >}}
Mivel SSL-t szeretnék használni a Grafana és a kapcsolódó felület számára, még mindig létre kell hozni egy tanúsítványt:
{{< terminal >}}
mkdir ssl
...
Végül létrehozok egy "telegraf.conf" fájlt ezzel a tartalommal:
```
[global_tags]
...
```
Most indítsa el a Grafana kiszolgálót ezzel a Compose hívással:
{{< terminal >}}
...
Most már meg tudom hívni a kiszolgálót, konfigurálhatom az adatbázist, létrehozhatom a műszerfalat és több mérési adatot csatlakoztathatok.
