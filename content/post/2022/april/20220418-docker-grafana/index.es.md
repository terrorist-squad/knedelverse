+++
date = "2022-04-18"
title = "Grandes cosas con contenedores: Grafana en el Synology - Diskstation"
difficulty = "level-3"
tags = ["Monitoring", "Grafana", "Docker", "docker-compose", "Synology", "influxdb", "telegraf"]
githublink = "https://github.com/terrorist-squad/knedelverse/blob/master/content/post/2022/april/20220418-docker-grafana/index.es.md"
+++
Grafana es una aplicación de código abierto multiplataforma para visualizar gráficamente los datos de varias fuentes de datos como InfluxDB, MySQL, PostgreSQL o Prometheus. Hoy muestro cómo instalar un servicio Grafana en el Synology DiskStation.
...
## Paso 2: Crear la carpeta Grafana
Creo un nuevo directorio llamado "grafana" en el directorio Docker.
{{< gallery match="images/3/*.png" >}}
Luego creo un archivo "grafana.yml" en el directorio de Grafana con este contenido:
```
version: "2"
services:
  grafana:
...
```
Creo dos subcarpetas más para los datos:
{{< terminal >}}
mkdir grafana
mkdir influxdb
...
{{</ terminal >}}
Como quiero usar SSL para Grafana y la interfaz asociada, todavía hay que crear un certificado:
{{< terminal >}}
mkdir ssl
...
Finalmente, creo un archivo "telegraf.conf" con este contenido:
```
[global_tags]
...
```
Ahora inicie el servidor de Grafana con esta llamada de composición:
{{< terminal >}}
...
Ahora puedo llamar al servidor, configurar la base de datos, crear el cuadro de mando y conectar más datos de medición.
