+++
date = "2022-04-18"
title = "Lucruri grozave cu containere: Grafana pe Synology - Diskstation"
difficulty = "level-3"
tags = ["Monitoring", "Grafana", "Docker", "docker-compose", "Synology", "influxdb", "telegraf"]
githublink = "https://github.com/terrorist-squad/knedelverse/blob/master/content/post/2022/april/20220418-docker-grafana/index.ro.md"
+++
...
Apoi creez un fișier "grafana.yml" în directorul Grafana cu acest conținut:
```
version: "2"
services:
  grafana:
...
{{</ terminal >}}
Deoarece vreau să folosesc SSL pentru Grafana și interfața asociată, trebuie creat un certificat:
{{< terminal >}}
mkdir ssl
