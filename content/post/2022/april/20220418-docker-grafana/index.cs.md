+++
date = "2022-04-18"
title = "Skvělé věci s kontejnery: Grafana na Synology - Diskstation"
difficulty = "level-3"
tags = ["Monitoring", "Grafana", "Docker", "docker-compose", "Synology", "influxdb", "telegraf"]
githublink = "https://github.com/terrorist-squad/knedelverse/blob/master/content/post/2022/april/20220418-docker-grafana/index.cs.md"
+++
Grafana je multiplatformní open source aplikace pro grafické zobrazování dat z různých datových zdrojů, jako jsou InfluxDB, MySQL, PostgreSQL nebo Prometheus. Dnes ukážu, jak nainstalovat službu Grafana na stanici Synology DiskStation.
...
## Krok 2: Vytvoření složky Grafana
V adresáři Docker vytvořím nový adresář s názvem "grafana".
{{< gallery match="images/3/*.png" >}}
Poté vytvořím v adresáři Grafana soubor grafana.yml s tímto obsahem:
```
version: "2"
services:
  grafana:
...
```
Vytvořím další dvě podsložky pro data:
{{< terminal >}}
mkdir grafana
mkdir influxdb
...
{{</ terminal >}}
Protože chci pro Grafanu a související rozhraní používat protokol SSL, je třeba vytvořit certifikát:
{{< terminal >}}
mkdir ssl
...
Nakonec vytvořím soubor "telegraf.conf" s tímto obsahem:
```
[global_tags]
...
```
Nyní spusťte server Grafana pomocí tohoto volání Compose:
{{< terminal >}}
...
## Krok 3: Konfigurace
Nyní mohu zavolat server, nakonfigurovat databázi, vytvořit ovládací panel a připojit další data měření.
