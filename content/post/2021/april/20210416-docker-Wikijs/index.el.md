...
Επιπλέον, πρέπει ακόμη να δημιουργηθεί ένας "σύνδεσμος" προς το δοχείο "mysql". Κάνω κλικ στην καρτέλα "Σύνδεσμοι" και επιλέγω το δοχείο βάσης δεδομένων. Το ψευδώνυμο θα πρέπει να διατηρηθεί για την εγκατάσταση του wiki.
