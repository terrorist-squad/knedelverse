...
title = "Suuria asioita konttien avulla: Netbox Synologyn kanssa - Diskstation"
difficulty = "level-3"
...
```
On erittäin tärkeää, että perintö "<<: *netbox" korvataan ja syötetään portti "netboxille". Tämän jälkeen voin käynnistää Compose-tiedoston:
{{< terminal >}}
