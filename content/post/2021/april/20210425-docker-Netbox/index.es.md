...
title = "Grandes cosas con contenedores: Netbox en Synology - Diskstation"
difficulty = "level-3"
...
```
Es muy importante que la herencia "<<: *Se sustituye "netbox" y se introduce un puerto para "netbox", tras lo cual puedo iniciar el archivo Compose:
{{< terminal >}}
