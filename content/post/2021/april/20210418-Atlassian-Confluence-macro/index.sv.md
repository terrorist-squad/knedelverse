...
## Steg 1: Skapa ett användarmakro
Jag klickar på "User Macros" > "Create User Macro" i området "Administration".
{{< gallery match="images/2/*.png" >}}
Jag anger sedan namnet på användarmakot och väljer alternativet "Definiera användarmakot" "Rendered".
{{< gallery match="images/3/*.png" >}}

## Steg 2: Utveckla användarmakro
Varje "renderat" användarmakro har som standard en kroppsvariabel:
```
Inhalt $body

```
Alla andra variabler definieras i makrokoden. Mer om variabler
```

## @param Title:title=Titlebar Title|type=string|required=truel|default=Bash

```
Nu saknas bara lite HTML/CSS och Marco är klar! Till exempel:
```
...
## Steg 3: Använd användarmakro
Om användaren marko får variabler, HTML och CSS kan detta användas.
