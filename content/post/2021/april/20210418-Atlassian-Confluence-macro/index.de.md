...
Ich klicke im „Administration“-Bereich auf „Benutzermacros“ > „Benutzermakro erstellen“.
{{< gallery match="images/2/*.png" >}}


Anschließend gebe ich den Benutzermakro-Namen ein und wählen die „Benutzermakros definieren“-Option „Gerendert“.
{{< gallery match="images/3/*.png" >}}

## Schritt 2: Benutzermakro entwickeln
Jedes „gerenderte“ Benutzermacro hat standardmäßig eine Body-Variable:
```
Inhalt $body
```

Alle weiteren Variablen werden im Macro-Code definiert. Mehr zum Variablen-Thema
```
## @param Title:title=Titlebar Title|type=string|required=truel|default=Bash
```

Nun fehlt noch ein bisschen HTML/CSS und das Marco ist fertig! Zum Beispiel:
```
## @param Title:title=Titlebar Title|type=string|required=truel|default=Bash
...
## Schritt 3: Benutzermakro Nutzen

Wenn das Benutzermarko mit Variablen, HTML und CSS versehen ist, kann dieses genutzt werden.
