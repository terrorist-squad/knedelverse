...
Napsautan "User Macros" > "Create User Macro" (Luo käyttäjämakro) "Administration" -alueella.
{{< gallery match="images/2/*.png" >}}
Syötän sitten käyttäjän makron nimen ja valitsen "Käyttäjän makrojen määrittäminen" -vaihtoehdon "Rendered".
{{< gallery match="images/3/*.png" >}}

## Vaihe 2: Kehitä käyttäjämakro
Jokaisella "renderöidyllä" käyttäjämakrolla on oletusarvoisesti runkomuuttuja:
```
Inhalt $body

```
Kaikki muut muuttujat määritellään makrokoodissa. Lisää muuttujista
```

## @param Title:title=Titlebar Title|type=string|required=truel|default=Bash

```
Nyt puuttuu vain vähän HTML/CSS:ää ja Marco on valmis! Esimerkiksi:
```
...
## Vaihe 3: Käytä käyttäjän makroa
Jos käyttäjälle marko annetaan muuttujat, HTML ja CSS, tätä voidaan käyttää.
