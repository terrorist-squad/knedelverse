+++
date = "2021-03-24"
title = "Krótka historia: Moja konfiguracja Gitlaba"
difficulty = "level-3"
tags = ["code", "development", "devops", "docker-compose", "git", "gitlab", "Synology"]
githublink = "https://github.com/terrorist-squad/knedelverse/blob/master/content/post/2021/march/20210324-Gitlab-setup/index.pl.md"
+++
Po moim pierwszym tutorialu na temat "Gitlab na stacji dysków Synology" już kilka razy pytano mnie, czy nadal korzystam z tego rozwiązania. Nie! W międzyczasie przeniosłem moje narzędzia Atlassian i następującą po nich instalację GitLab na intelowski komputer NUC. W załączeniu pokazuję mój aktualny plik Compose, który oczywiście można również uruchomić na stacji dysków Synology. Widać wyraźnie, że używam teraz specjalnych ustawień dla OpenLDAP, rejestru kontenerów, poczty, certyfikatów i logowania. Ponadto funkcja wiki i issue tracker została wyłączona, ponieważ używam programów Atlassian-Jira i Atlassian-Confluence. Jak widać, Gitlab jest bardzo elastyczny. Miłej zabawy!
```
version: '2'
services:
  gitlab:
